...
namespace CUE.Net.Helper
{
    ...
    public static class ColorHelper
    {
        ...
        public static CorsairColor Blend(this CorsairColor bg, CorsairColor fg)
        {
            ...
            var resultA = 1f - (1f - fg.GetFloatA()) * (1f - bg.GetFloatA());
            var resultR = fg.GetFloatR() * fg.GetFloatA() / resultA + bg.GetFloatR() * bg.GetFloatA() * (1f - fg.GetFloatA()) / resultA;
            var resultG = fg.GetFloatG() * fg.GetFloatA() / resultA + bg.GetFloatG() * bg.GetFloatA() * (1f - fg.GetFloatA()) / resultA;
            var resultB = fg.GetFloatB() * fg.GetFloatA() / resultA + bg.GetFloatB() * bg.GetFloatA() * (1f - fg.GetFloatA()) / resultA;
        ...
        public static CorsairColor CreateColorFromFloat(float a, float r, float g, float b) => new CorsairColor(GetIntColorFromFloat(a),
            GetIntColorFromFloat(r), GetIntColorFromFloat(g), GetIntColorFromFloat(b));
        ...
        public static byte GetIntColorFromFloat(float f)
        {
            ...
            var calcF = (float) Math.Max(0f, Math.Min(1f, f));
        ...
        public static CorsairColor ColorFromHSV(float hue, float saturation, float value, byte alpha = 255)
        {
            if(saturation <= 0.0)
            {
                var val = GetIntColorFromFloat(value);
            ...
            switch(i)
            {
                case 0: return new CorsairColor(alpha, GetIntColorFromFloat(value), GetIntColorFromFloat(t), GetIntColorFromFloat(p));
                case 1: return new CorsairColor(alpha, GetIntColorFromFloat(q), GetIntColorFromFloat(value), GetIntColorFromFloat(p));
                case 2: return new CorsairColor(alpha, GetIntColorFromFloat(p), GetIntColorFromFloat(value), GetIntColorFromFloat(t));
                case 3: return new CorsairColor(alpha, GetIntColorFromFloat(p), GetIntColorFromFloat(q), GetIntColorFromFloat(value));
                case 4: return new CorsairColor(alpha, GetIntColorFromFloat(t), GetIntColorFromFloat(p), GetIntColorFromFloat(value));
                default: return new CorsairColor(alpha, GetIntColorFromFloat(value), GetIntColorFromFloat(p), GetIntColorFromFloat(q));
            }
        }
