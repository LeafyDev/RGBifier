    ...
    public class LinearGradient : AbstractGradient
    {
        ...
        public override CorsairColor GetColor(float offset)
        {
            ...
            if(WrapGradient)
            {
                ...
                if(gsBefore == null)
                {
                    var lastStop = orderedStops[orderedStops.Count - 1];
            ...
            var colA = (byte) ((gsAfter.Color.A - gsBefore.Color.A) * blendFactor + gsBefore.Color.A);
            var colR = (byte) ((gsAfter.Color.R - gsBefore.Color.R) * blendFactor + gsBefore.Color.R);
            var colG = (byte) ((gsAfter.Color.G - gsBefore.Color.G) * blendFactor + gsBefore.Color.G);
            var colB = (byte) ((gsAfter.Color.B - gsBefore.Color.B) * blendFactor + gsBefore.Color.B);
        ...
        public LinearGradient(params GradientStop[] gradientStops) : base(gradientStops) { }

        /// <summary>
        ///   Initializes a new instance of the <see cref="AbstractGradient" /> class.
        /// </summary>
        /// <param name="wrapGradient">
        ///   Specifies whether the gradient should wrapp or not (see
        ///   <see cref="AbstractGradient.WrapGradient" /> for an example of what this means).
        /// </param>
        /// <param name="gradientStops">The stops with which the gradient should be initialized.</param>
        public LinearGradient(bool wrapGradient, params GradientStop[] gradientStops) : base(wrapGradient, gradientStops) { }
