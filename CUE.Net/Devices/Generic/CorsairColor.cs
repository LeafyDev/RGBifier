...
namespace CUE.Net.Devices.Generic
{
    ...
    public class CorsairColor
    {
        ...
        /// </summary>
        /// <returns>
        ///   A string that contains the individual byte-values of this <see cref="CorsairColor" />. For example "[A: 255,
        ///   R: 255, G: 0, B: 0]".
        /// </returns>
        public override string ToString() => $"[A: {A}, R: {R}, G: {G}, B: {B}]";

        /// <summary>
        ///   Tests whether the specified object is a <see cref="CorsairColor" /> and is equivalent to this
        ///   <see cref="CorsairColor" />.
        /// </summary>
        /// <param name="obj">The object to test.</param>
        /// <returns>
        ///   true if <paramref name="obj" /> is a <see cref="CorsairColor" /> equivalent to this
        ///   <see cref="CorsairColor" /> ; otherwise, false.
        /// </returns>
        ...
        public static bool operator ==(CorsairColor color1, CorsairColor color2) => ReferenceEquals(color1, null) ? ReferenceEquals(color2, null)
