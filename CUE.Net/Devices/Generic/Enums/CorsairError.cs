...
namespace CUE.Net.Devices.Generic.Enums
{
    ...
    public enum CorsairError
    {
        ...
        ///   server or client or because the function is new and server is too old.
        ///   Check CorsairProtocolDetails for details). (developer error)
        /// </summary>
        IncompatibleProtocol,

        /// <summary>
        ///   If developer supplied invalid arguments to the function (for specifics look at function descriptions). (developer
        ///   error)
        /// </summary>
        InvalidArguments
    }
